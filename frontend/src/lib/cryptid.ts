...
export const getCryptidWalletAdapter = (network: WalletAdapterNetwork = DEFAULT_SOLANA_NETWORK) => {
...
export const getDIDFromCryptid = async (wallet: WalletAdapter): Promise<{
  did: string,
  keyName: string,
}> => {
