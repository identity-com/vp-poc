<template>
  <div>
    ...
    <v-btn outlined color="primary" @click="sign" v-if="connected">Sign</v-btn>
  </div>
</template>
<script lang="ts">
import Vue from 'vue';
...
export default Vue.extend({
  ...
  methods: {
    onWalletConnected(wallet: WalletAdapter) {
      connectedWallet = wallet;
      this.connected = true;
    },
    async sign() {
      presentation.sign(connectedWallet, this.presentation);
    },
  },
  created() {
    this.presentation = {
      ...
      verifiableCredential: [
        {
          ...
          granted: '3045022100ef7bcfb23b4ae99696343981c648ff934e77fd1dfbe1fe79c3881e71bdb8a1a302207ca8f9f9bb788f125162be67c848bce5f3fdc2a91173aced1c424e2e5961922d',
          '@context': [
            'https://www.w3.org/2018/credentials/v1',
        ...
        },
        {
          ...
          version: '1',
          issuer: 'did:ethr:0x4660613f3e5e84970ad0f4ad498389ecea2e1233',
          granted: '3044022006ed819b5b0cb8fedf58aeaa44b47e2e664c636ae04b4b288100f01446913064022071b5f9407276bc399d9df1742880b5605477521b430ab9e5f70d07685a899204',
          '@context': [
            'https://www.w3.org/2018/credentials/v1',
            'https://www.identity.com/credentials/v1',
          ],
