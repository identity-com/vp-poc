...
export default Vue.extend({
  ...
  ccreated() {
    this.gkToken = '{\n'
      + ' "issuingGatekeeper": "tgkVESD66NpqbCcEkjAEUkhwtmYkJ6Wc2jLcxHiLzHx",\n'
      + ' "gatekeeperNetwork": "tgnuXXNMDLK8dy7Xm1TdeGyc95MDym4bvAQCwcW21Bf",\n'
      + ' "owner": "8XTUamtN3nrHU1233PcLGpRRFb6nVmR3yGv5dFiSrcaf",\n'
      + ' "state": "ACTIVE",\n'
      + ' "publicKey": "D7UJ8334hnj8x42Q6p2iSXh5cXjFfFPFwCRcNkDk56ZW",\n'
      + ' "programId": "gatem74V238djXdzWnJf94Wo1DcnuGkfijbf3AuBhfs"\n'
      + '}';
    this.cryptidAccount = '8XTUamtN3nrHU1233PcLGpRRFb6nVmR3yGv5dFiSrcaf';
    this.civicAuthCode = 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..f8aLpbET0GJJScgSDZr61qHepIT-SxZ9ZokBBfqifYYX8uS3NjI04_pYxc8WMH7beD0ZDvEXSbhSXRQs9hoCtg';
    this.did = {
      did: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
      keyname: 'default',
      pubKey: '3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
      ...
      document: {
        ...
        id: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
        controller: [],
        verificationMethod: [
          {
            id: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#default',
            type: 'Ed25519VerificationKey2018',
            controller: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
            publicKeyBase58: '3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
          },
          {
            id: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#Device_B',
            type: 'Ed25519VerificationKey2018',
            controller: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF',
            publicKeyBase58: 'C3PtfFPpL6WXjQEGKuei5sZdbtUKzQ7CjPeqenceeiox',
          },
        ],
        authentication: [],
        assertionMethod: [],
        ...
        capabilityInvocation: [
          'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#default',
          'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#Device_B',
        ],
      ...
      verifiableCredential: [
        {
          ...
          granted: '30450221009375e4398db0482bc309a78a7e03226392b0d7886a1a3079e434e82bd65c31410220015637da3c0c7eb1424947241d841907a3a5a7280c43f67c11739f8ce3cd57ab',
          '@context': [
            'https://www.w3.org/2018/credentials/v1',
        ...
        },
        {
          ...
          proof: {
            ...
            merkleRootSignature: {
              pubBase58: 'xpub661MyMwAqRbcH4Fx3W36ddbLfZwHsguhE6x7JxwbX5E1hY8ov9L4CrNfCCQpV8pVK64CVqkhYQ9QLFgkVAUqkRThkTY1R4GiWHNZtAFSVpD',
              signature: '3045022100d843452c6b551981a734387662ca77b7419d2554b1553318aca70a8302b08c3002201cb3d68c6880f6a738f7fa8f9e2686d593331a611dc14fc1e05f593839ca84c5',
              algo: 'ec256k1',
            },
            type: 'CvcMerkleProof2018',
            leaves: [
              {
                ...
                node: [
                  {
                    right: '60c8d1a05affc8066469e822733fe2b75f083f8ff3d6f03b9421c6f6ec4cd21f',
                  },
                  {
                  ...
                  {
                    right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795',
                  },
                  {
                    right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48',
                  },
                ],
                claimPath: 'contact.phoneNumber',
                targetHash: 'd3c59b1575714b922772ac65ba2d62fd42b06d74402efa22c773d4694eb31535',
                value: 'urn:phoneNumber.country:63570b5c321f3e49a15b0da13ff092d2088f2325312598d1f946dd1c2d18080f:ZA|urn:phoneNumber.countryCode:752db3295210070f1db0fb04cd47d3957fc78f10072b7e194dc84314774a164e:27|urn:phoneNumber.lineType:fd727415632723ac7eaa9d6a39a1af08086fa0d74d33b17cb2a69417b1485218:mobile|urn:phoneNumber.number:9126a0d2b89a8396376d043776612c99c257b228dd7b1f65f1023780a9a9d43e:829283948|',
              },
              {
                identifier: 'claim-cvc:PhoneNumber.country-v1',
                node: [
                  {
                    left: 'd3c59b1575714b922772ac65ba2d62fd42b06d74402efa22c773d4694eb31535',
                  },
                  {
                    right: '098e94f02947f7c2aff642c47969b58a1532251e1d4afd23d52e41dac99f85ed',
                  },
                ...
                claimPath: 'contact.phoneNumber.country',
                targetHash: '60c8d1a05affc8066469e822733fe2b75f083f8ff3d6f03b9421c6f6ec4cd21f',
                value: 'urn:country:63570b5c321f3e49a15b0da13ff092d2088f2325312598d1f946dd1c2d18080f:ZA|',
              },
              {
                identifier: 'claim-cvc:PhoneNumber.countryCode-v1',
                node: [
                  {
                    right: '18a5f23c070cc27e84f54504b0d45cb8bee66a73e6aeb2089d17399497022dc2',
                  },
                  {
                    left: '4043681679e5c9239aa55883fe95437737ac5743f7bf0a660d185467961bec89',
                  },
                  {
                    right: 'eca78e2f2a80018e8ba2ee4e2daad85dfb991462f281ee47fe9383c12dac9e6a',
                  },
                ...
                targetHash: '8864c6a4fbc869ca33c1296841ad3124cda0b0111a38fb8a06b783954285a84b',
                value: 'urn:countryCode:752db3295210070f1db0fb04cd47d3957fc78f10072b7e194dc84314774a164e:27|',
              },
              {
                identifier: 'claim-cvc:PhoneNumber.lineType-v1',
                node: [
                  {
                    left: '8864c6a4fbc869ca33c1296841ad3124cda0b0111a38fb8a06b783954285a84b',
                  },
                  {
                    left: '4043681679e5c9239aa55883fe95437737ac5743f7bf0a660d185467961bec89',
                  },
                ...
                claimPath: 'contact.phoneNumber.lineType',
                targetHash: '18a5f23c070cc27e84f54504b0d45cb8bee66a73e6aeb2089d17399497022dc2',
              ...
              },
              {
                ...
                node: [
                  {
                    right: '4540ef4a79d9b00ad2599e68f5c7516f4a7e99cffc9abe1891354a598245278c',
                  },
                  {
                    right: '62388a734b211fc9562dca9eeb16abb9cc24026e3d72716dee091403f167fd59',
                  },
                  {
                    left: 'ce713e6305763707b67bb7209f44b2ca1c8f556f379aecc6b9c9e6621e9e5597',
                  },
                  {
                    right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795',
                  },
                ...
                targetHash: '23d8323a124f3890f87bd58700cf5f2e7df31a3cfed37447847c0b449123054f',
                value: 'urn:number:9126a0d2b89a8396376d043776612c99c257b228dd7b1f65f1023780a9a9d43e:829283948|',
              },
              {
                identifier: 'cvc:Meta:issuer',
                node: [
                  {
                    left: '23d8323a124f3890f87bd58700cf5f2e7df31a3cfed37447847c0b449123054f',
                  },
                  {
                    right: '62388a734b211fc9562dca9eeb16abb9cc24026e3d72716dee091403f167fd59',
                  },
                ...
                claimPath: 'meta.issuer',
                targetHash: '4540ef4a79d9b00ad2599e68f5c7516f4a7e99cffc9abe1891354a598245278c',
                value: 'urn:issuer:b7a95062da46ef771d9b69c905822e1f415a2a247d4e919a112e557e3a530671:did:ethr:0x4660613f3e5e84970ad0f4ad498389ecea2e1233|',
              },
              {
                identifier: 'cvc:Meta:issuanceDate',
                node: [
                  {
                    right: '52b26e10cd074a3561d09fce6ec4e8fbefd3d8a1efdd6b9d8976b23f47b69d69',
                  },
                  {
                ...
                claimPath: 'meta.issuanceDate',
                targetHash: '24e3da13ac406ce4f22993d9e7a17249c7aed331e3164603e189e8e4abcb4234',
                value: 'urn:issuanceDate:d46f4354b18f0553ee2ea0ca75d4da3598b6877e3f214d7e9eb27dfec8dddd3b:2021-05-28T10:59:52.372Z|',
              },
              {
                identifier: 'cvc:Meta:expirationDate',
                node: [
                  {
                    left: '24e3da13ac406ce4f22993d9e7a17249c7aed331e3164603e189e8e4abcb4234',
                  },
                  {
                    left: '31742981f3647c6119514bd6405e97f2a5a7d058e425a07edb9826679b534bed',
                  },
                ...
                claimPath: 'meta.expirationDate',
                targetHash: '52b26e10cd074a3561d09fce6ec4e8fbefd3d8a1efdd6b9d8976b23f47b69d69',
                value: 'urn:expirationDate:08e312874e6cefc3cd34aee2cd86e0316f1b70ed4311e2afbc11f3df4558071c:null|',
              },
            ],
            anchor: {
              schema: 'bch-20180201',
              ...
              subject: {
                ...
                pub: 'xpub6aAXEmqoPdQ1o68g5gQKG4yzzGmebFxMf1tj294C84mxtmbqRZR5FVkXXB4GvDQ3fi6pPSTAXy499z8h4HMYSA2M27NuabfQ9nSEQUEryLg',
              ...
              cosigners: [
                ...
                {
                  pub: 'xpub661MyMwAqRbcGqg7oAqhbwrok1ekiQFFxBe1Eb33CVEQeoNzyWHHE4g42gWecn7Lse38HunBaSaUjBDRHJ6kKMcL3Lpi3gUvTh1RErfECH8',
                },
              ],
              type: 'temporary',
              network: 'bitcoincash',
          ...
          version: '1',
          issuer: 'did:ethr:0x4660613f3e5e84970ad0f4ad498389ecea2e1233',
          granted: '30430220708ba4c048640b7d9aedecce8ac9455a40acfd6de9987ebf081f427195e2cc0a021f5d1477e18f645239b7407bdab9dd068594bce1999e7f05604abce083be9c99',
          '@context': [
            'https://www.w3.org/2018/credentials/v1',
            'https://www.identity.com/credentials/v1',
          ],
          ...
          meta: {
            ...
            issuanceDate: '2021-05-28T10:59:52.372Z',
          },
        },
      ],
      proof: {
        type: 'JsonWebSignature2020',
        created: '2021-10-27T18:23:28Z',
        verificationMethod: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#default',
        proofPurpose: 'authentication',
        challenge: '5106d1a4-fa20-469c-b9d7-e3376318428d',
        jws: 'eyJhbGciOiJFZERTQSIsImI2NCI6ZmFsc2UsImNyaXQiOlsiYjY0Il19..fvNE7WAPZUGf_kjQ9Dwa-yGqTFNjupjSxilCRBpSMDSasS0mDWzpXXr5o7ElTdDoG4vcEQJ80oAA64-so9qrBw',
      },
    };
  },
});
