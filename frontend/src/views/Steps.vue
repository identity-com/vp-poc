...
export default Vue.extend({
  ...
  created() {
    ...
    this.civicAuthCode = 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..Mg8Q1QI8wKVOkzfvr2n432j8VAUeRDx88WIV-XO2ZZhtG_lphOehrKugfSiojIF_MGE1Q3fbGXpPnjl9pTK2fw';
      ...
      verifiableCredential: [{
        ...
        proof: {
          ...
          leaves: [{
            ...
            node: [{ right: '90ef29c41a5d51762f5485cbe5850a34cb69b893a065c105b4834809f969525f' }, { right: 'f3ef0545a6f61f2e3389516ed0fc667f53497556bfda96bd8517ee69b900f7ce' }, { right: 'fd8fc2fbabd2c570b2c92c15c2450e2c7415d9d186fa42ad92b6afaf366bf82a' }, { right: '0c894c162e89aef875a0b5b62a0fd066c03d53a401994f73bfd7cb448f9b9a9e' }, { right: 'e240a2e9739964c2d1e02821dc350a2aa20f2a067bc3290202f2fef4cc6af916' }],
            ...
            node: [{ left: 'd38bf743f973b93a0391cfdc459b0d028cb5f62b59d372b3e7b61cd44f1f82be' }, { right: 'f3ef0545a6f61f2e3389516ed0fc667f53497556bfda96bd8517ee69b900f7ce' }, { right: 'fd8fc2fbabd2c570b2c92c15c2450e2c7415d9d186fa42ad92b6afaf366bf82a' }, { right: '0c894c162e89aef875a0b5b62a0fd066c03d53a401994f73bfd7cb448f9b9a9e' }, { right: 'e240a2e9739964c2d1e02821dc350a2aa20f2a067bc3290202f2fef4cc6af916' }],
            ...
            node: [{ right: '234c9e609469e17d515ebded93ebefd5b8bc3704af0ae05c47139ec3a5209b78' }, { left: '2b264a81e4c465f6008bfd6a16a850f8625634cecd9be2b395c1c3a1bdb08929' }, { right: 'fd8fc2fbabd2c570b2c92c15c2450e2c7415d9d186fa42ad92b6afaf366bf82a' }, { right: '0c894c162e89aef875a0b5b62a0fd066c03d53a401994f73bfd7cb448f9b9a9e' }, { right: 'e240a2e9739964c2d1e02821dc350a2aa20f2a067bc3290202f2fef4cc6af916' }],
            ...
            node: [{ left: 'd04a1a4c2b12602b0d13ebe88fad8ca129cbe7a22fa0760a5a209fd07f180078' }, { left: '2b264a81e4c465f6008bfd6a16a850f8625634cecd9be2b395c1c3a1bdb08929' }, { right: 'fd8fc2fbabd2c570b2c92c15c2450e2c7415d9d186fa42ad92b6afaf366bf82a' }, { right: '0c894c162e89aef875a0b5b62a0fd066c03d53a401994f73bfd7cb448f9b9a9e' }, { right: 'e240a2e9739964c2d1e02821dc350a2aa20f2a067bc3290202f2fef4cc6af916' }],
            ...
            node: [{ right: 'e177beab779472cf6dfab025e13c479755ab82cb31802f8b7149f3749559d5e1' }, { right: '38b1f6578eb6d962dbb4e84ffd478c3115f08f93b334d94ca38e9df5ba04897b' }, { left: '75c2de970bdd44049152fc9066b2489f5cade89643e5065454322887c425cd1a' }, { right: '0c894c162e89aef875a0b5b62a0fd066c03d53a401994f73bfd7cb448f9b9a9e' }, { right: 'e240a2e9739964c2d1e02821dc350a2aa20f2a067bc3290202f2fef4cc6af916' }],
        ...
        meta: {
          type: ['Credential', 'credential-cvc:Email-v1'],
        ...
        proof: {
          ...
          leaves: [{
            ...
            node: [{ left: 'd3c59b1575714b922772ac65ba2d62fd42b06d74402efa22c773d4694eb31535' }, { right: '098e94f02947f7c2aff642c47969b58a1532251e1d4afd23d52e41dac99f85ed' }, { right: 'eca78e2f2a80018e8ba2ee4e2daad85dfb991462f281ee47fe9383c12dac9e6a' }, { right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795' }, { right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48' }],
            ...
            node: [{ left: '8864c6a4fbc869ca33c1296841ad3124cda0b0111a38fb8a06b783954285a84b' }, { left: '4043681679e5c9239aa55883fe95437737ac5743f7bf0a660d185467961bec89' }, { right: 'eca78e2f2a80018e8ba2ee4e2daad85dfb991462f281ee47fe9383c12dac9e6a' }, { right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795' }, { right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48' }],
            ...
            identifier: 'cvc:Meta:issuer',
            node: [{ left: '23d8323a124f3890f87bd58700cf5f2e7df31a3cfed37447847c0b449123054f' }, { right: '62388a734b211fc9562dca9eeb16abb9cc24026e3d72716dee091403f167fd59' }, { left: 'ce713e6305763707b67bb7209f44b2ca1c8f556f379aecc6b9c9e6621e9e5597' }, { right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795' }, { right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48' }],
            claimPath: 'meta.issuer',
            ...
            identifier: 'cvc:Meta:issuanceDate',
            node: [{ right: '52b26e10cd074a3561d09fce6ec4e8fbefd3d8a1efdd6b9d8976b23f47b69d69' }, { left: '31742981f3647c6119514bd6405e97f2a5a7d058e425a07edb9826679b534bed' }, { left: 'ce713e6305763707b67bb7209f44b2ca1c8f556f379aecc6b9c9e6621e9e5597' }, { right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795' }, { right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48' }],
            claimPath: 'meta.issuanceDate',
            ...
            identifier: 'cvc:Meta:expirationDate',
            node: [{ left: '24e3da13ac406ce4f22993d9e7a17249c7aed331e3164603e189e8e4abcb4234' }, { left: '31742981f3647c6119514bd6405e97f2a5a7d058e425a07edb9826679b534bed' }, { left: 'ce713e6305763707b67bb7209f44b2ca1c8f556f379aecc6b9c9e6621e9e5597' }, { right: 'a0e03ea307e8da03d7f63bb4503ef6e7a9cd16ab388f7293dc9c929b1ded5795' }, { right: 'b1a54752d39842b3520f4a1e12a28dd76e04c842b9b912c22d3f839f0a755e48' }],
            claimPath: 'meta.expirationDate',
        ...
        credentialSubject: { id: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#default' },
        meta: {
          type: ['Credential', 'credential-cvc:PhoneNumber-v1'],
          issuanceDate: '2021-05-28T10:59:52.372Z',
        },
      }],
      proof: {
        type: 'JsonWebSignature2020',
        created: '2021-10-26T12:56:05Z',
        verificationMethod: 'did:sol:devnet:3emPMNueBjcnLxpxJLrakNjBHyXZdZ1djdgqUvYNwpXF#default',
        proofPurpose: 'authentication',
        challenge: '6f5ce4dc-c348-4026-bc0a-a292615360c2',
        jws: 'eyJhbGciOiJFZERTQSIsImI2NCI6ZmFsc2UsImNyaXQiOlsiYjY0Il19..2ia-Vv5NSi5eFB_6sgjek0UdEVv0aS7aoXHMeZgWIHHxFuGb3QKUFnQ1xPuxjSX-gIurYSPbsWOdHA7CuhwHBg',
      },
    };
  },
});
