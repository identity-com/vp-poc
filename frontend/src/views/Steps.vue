...
const KEY = '22jH4D3nP2aELBvEMFHYd16MQNACy3zSKJTNj3aM2ic8nbkT9KEYEFMcg5XXr39KNe8GMFYefVAyfvEGLniZ884u';
...
export default Vue.extend({
  ...
  methods: {
    ...
    async onAuthCodeExchanged(data: { credentials: any }) {
      ...
      this.signedVp = await presentation.sign(jwkPvt, vp);
